                ...
                foreach ($categories as $category) { ?>
                    <tr>
                        ...
                        <td><label id="editText<?= $category->category_id; ?>"><?php echo $category->category_name; ?></label>
                            <input class="form-control editData" id="editInput<?= $category->category_id; ?>" value="<?php echo $category->category_name; ?>">
                        </td>
                        <td class="text-center"><?php echo count($Product[$i]); ?></td>
                        <td style="float: right;">
                            <div class="row">
                                <div class="col"><a href="#" class="btn btn-warning editButton" id="editButton_<?= $category->category_id; ?>">EDIT</a>&nbsp;
                                </div>
                                <div class="col"><a href="#" class="btn btn-danger deleteButton" data-toggle="modal" data-target="#deleteModal<?= $category->category_id; ?>" id="deleteButton_<?= $category->category_id; ?>">DELETE</a>
                                </div>
                            </div>
                        </td>
                    </tr>
