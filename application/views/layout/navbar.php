...
<!-- <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <div class="col-2"><a class="navbar-brand" href="<?php echo base_url("indexCon/index"); ?>">
        ...
        <div class="col-md-10 " id="header-pc">
            <div class="row"  >
                ...
                <div class="col-10 col-md-8 mr-auto">
                    <div class="navbar-nav">
                        <form class=" my-auto d-inline w-100">
                            <div class="input-group">
                                <input type="search" class="form-control" placeholder="Search...">
                                <span class="input-group-append"><button class="btn btn-primary" type="button"><i class="fas fa-search"></i></button></span>
                ...
                <div class="col-md-4 ml-auto" id="menu1div" >
                    <div class="navbar-nav"  >
