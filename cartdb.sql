...
INSERT INTO `product` (`product_id`, `product_name`, `vendor_id`, `description`, `price`, `category_id`, `status`) VALUES
	...
	(0000000002, 'ESP8266 module', 0000000002, 'ESP8366 module WiFi for Arduino', 30, 0000000001, 1),
	(0000000003, 'Energy Drinks', 0000000003, 'Lemon flavor energy drinks', 15, 0000000003, 1),
